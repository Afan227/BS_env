...
params = {
    ...
    0: {"N_max": 50, "sigma": [15, 7], "mu": [15, 10], "type": "west"},
    1: {"N_max": 50, "sigma": [15, 7], "mu": [35, 10], "type": "west"},

    # 东区（原x=350→43.75，y=100→25）
    2: {"N_max": 100, "sigma": [20, 7], "mu": [25, 45], "type": "east"},

    # 南区（原x=200→25，y=30→7.5）
    3: {"N_max": 100, "sigma": [7, 25], "mu": [5, 25], "type": "east"},

    # 北区（原x=200→25，y=170→42.5）
    4: {"N_max": 100, "sigma": [7, 25], "mu": [45, 25], "type": "east"},

    # 出入口（原x=250→31.25，y=280→超出范围需修正）
    8: {"N_max": 200, "sigma": [15*0.125, 15*0.125], "mu": [250*0.125, min(280*0.25, 50)], "type": "gate"},
    9: {"N_max": 200, "sigma": [15*0.125, 15*0.125], "mu": [250*0.125, 20*0.25], "type": "exit"}
}
